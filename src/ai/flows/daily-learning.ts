...
const RoadmapStepSchema = z.object({
  ...
  points: z.number().int().min(5).max(20).describe('The points awarded for completing this step, based on duration/effort (e.g., 5-20 points). A longer duration/higher complexity should result in more points.'),
});
...
4.  **points**: An integer point value between 5 and 20 based on the estimated duration and complexity. Longer durations or more complex topics should have more points.
